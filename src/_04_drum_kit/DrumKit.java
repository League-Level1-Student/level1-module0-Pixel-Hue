...
cymbalLabelWithImage = createLabelImage(image2);
b.add(cymbalLabelWithImage);
b.setLayout(new GridLayout());
a.pack();
cymbalLabelWithImage.addMouseListener(this);
String image3 = "snare.jpg";
snareLabelWithImage=createLabelImage(image3);
b.add(snareLabelWithImage);
b.setLayout(new GridLayout());
a.pack();
...
playSound("drum.wav");//Sound doesn't work in VNC's
System.out.println("*Drum noise*");
		}
		else if (drumClicked.equals(cymbalLabelWithImage)) {
			playSound("cymbal.wav"); //Sound doesn't work in VNC's
			System.out.println("*Cymbal noise*");
		}
		else if (drumClicked.equals(snareLabelWithImage)) {
		//Sound doesn't work in VNC's
			System.out.println("*Snare noise*");
		}
