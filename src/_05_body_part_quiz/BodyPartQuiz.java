...
public class BodyPartQuiz {
	...
	private void startQuiz() {
		...
		if (guess2.equalsIgnoreCase("Leonardo")) {
			...
			JOptionPane.showMessageDialog(null, "Incorrect, it was Leonardo");
			score--;
		}
		showNextImage();
		...
		if (guess3.equalsIgnoreCase("Morgan")) {
			...
			JOptionPane.showMessageDialog(null, "Incorrect, it was Morgan");
			score--;
		}
		showNextImage();
...
JOptionPane.showMessageDialog(null, "Congragulations, you finished!\n     Your score was " + score);
	}
